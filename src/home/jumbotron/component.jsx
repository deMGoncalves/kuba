  ...
  <section className={style.jumbotron}>
    <s.Container>
      <picture className={style.jumbotron__picture}>
        <source srcSet='https://dummyimage.com/404x500/1A1A1A/1A1A1A.png' media='(max-width: 424px)' />
        <source srcSet='https://dummyimage.com/747x500/1A1A1A/1A1A1A.png' media='(min-width: 425px) and (max-width: 767px)' />
