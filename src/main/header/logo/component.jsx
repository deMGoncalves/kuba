...
export default (attr) =>
  <picture className={[style.logo, attr.className]} itemScope itemType='http://schema.org/Organization'>
    <source srcSet='https://dummyimage.com/120x40/1A1A1A/1A1A1A.png' media='(max-width: 469px)' />
    ...
    <img className='logo__img' loading='lazy' onClick={() => location.assign(location.origin)} alt='JRMod' itemProp='logo' />
