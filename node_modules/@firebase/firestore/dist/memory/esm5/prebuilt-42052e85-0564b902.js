 ...
 */ function N(t) {
    ...
    if (I.logLevel <= a.DEBUG) {
        var r = e.map(k);
        I.debug.apply(I, b([ "Firestore (8.4.0): " + t ], r));
    }
}
...
function S(t) {
    ...
    if (I.logLevel <= a.ERROR) {
        var r = e.map(k);
        I.error.apply(I, b([ "Firestore (8.4.0): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (I.logLevel <= a.WARN) {
        var r = e.map(k);
        I.warn.apply(I, b([ "Firestore (8.4.0): " + t ], r));
    }
}
...
export { vu as $, wu as B, Nu as G, Du as H, gu as L, Eu as Q, Cu as X, Ru as Y, Zo as _, F as a, Pu as e, yu as k, ts as m, Vu as n, bu as q, Mu as s, Ou as t, ss as v, du as x, Su as z };
//# sourceMappingURL=prebuilt-42052e85-0564b902.js.map
