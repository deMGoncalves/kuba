...
exports.checkAndPromptForEapPublisher = exports.promptForPublisherTOS = exports.prompt = exports.retrieveRoleInfo = exports.formatDescription = void 0;
...
const extensionsHelper_2 = require("./extensionsHelper");
...
async function checkAndPromptForEapPublisher(publisherId, sourceUrl) {
    ...
    if (!trustedPublishers.includes(publisherId)) {
        ...
        utils.logLabeledBullet(extensionsHelper_1.logPrefix, marked(warningMsg));
        return await extensionsHelper_2.confirmInstallInstance(false);
    }
    return true;
}
exports.checkAndPromptForEapPublisher = checkAndPromptForEapPublisher;
