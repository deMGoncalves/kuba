...
export default (tail) =>
  <>
    ...
    <text.Data className={[style.tail__data, style.master]} master xxs bold>{tail.master}</text.Data>
    <text.Data className={style.tail__data} master xxs bold>{tail.slave}</text.Data>
  </>
