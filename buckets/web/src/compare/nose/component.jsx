...
export default (nose) =>
  <>
    ...
    <text.Data className={[style.nose__data, style.master]} master xxs bold>{nose.master}</text.Data>
    <text.Data className={style.nose__data} master xxs bold>{nose.slave}</text.Data>
  </>
